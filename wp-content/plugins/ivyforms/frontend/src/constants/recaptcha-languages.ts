/**
 * reCAPTCHA Language Options
 *
 * These are the supported language codes for Google reCAPTCHA.
 * Languages marked with * have professional translations from Google.
 */
...
export const RECAPTCHA_LANGUAGE_OPTIONS: RecaptchaLanguageOption[] = [
  { label: 'browser_default', value: '' }, // Translation key for browser default
