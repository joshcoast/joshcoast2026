...
/**
 * Beach Wedding RSVP Form Template
 */
class BeachWeddingRSVPFormTemplate
{
    /**
    ...
    {
        return [
            'id' => 'beach_wedding_rsvp_form',
            'name' => BackendStrings::getTemplateStrings()['beach_wedding_rsvp_form'],
            'description' => BackendStrings::getTemplateStrings()[
                'beach_wedding_rsvp_form_description'
            ],
            'category' => 'event-registration-forms',
            'subcategory' => 'wedding-forms',
            'is_pro' => false,
            'screenshot' => IVYFORMS_TEMPLATES_IMAGES_URL . 'beach-wedding-rsvp-form.svg',
            'form_data' => [
                'name' => BackendStrings::getTemplateStrings()['beach_wedding_rsvp_form'],
                'published' => 1,
                'showTitle' => 1,
    ...
    /**
     * Attendance fields (will you attend, number of guests, arrival date)
     *
     * @return array<int, array<string, mixed>>
     */
    ...
    /**
     * Additional information fields (beach games, transportation, special messages)
     *
     * @return array<int, array<string, mixed>>
     */
    ...
    {
        return [
            // Participate in Beach Games?
            [
                'id' => 0,
                'fieldIndex' => 10,
                'type' => 'radio',
                'label' => BackendStrings::getTemplateStrings()['participate_in_beach_games'],
                'placeholder' => '',
                'required' => false,
                'parentId' => null,
                'defaultValue' => '',
            ...
            [
                ...
                'fieldIndex' => 11,
                'type' => 'radio',
                'label' => BackendStrings::getTemplateStrings()['need_transportation'],
                'placeholder' => '',
                'required' => false,
                'parentId' => null,
                'defaultValue' => '',
