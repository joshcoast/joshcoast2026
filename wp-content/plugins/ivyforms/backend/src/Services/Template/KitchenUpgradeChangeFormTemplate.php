...
class KitchenUpgradeChangeFormTemplate
{
    /**
     * Get the kitchen upgrade change form template
     *
    ...
    {
        return [
            'id' => 'kitchen_upgrade_change_form',
            'name' => BackendStrings::getTemplateStrings()['kitchen_upgrade_change_form'],
            'description' => BackendStrings::getTemplateStrings()['kitchen_upgrade_change_form_desc'],
            'category' => 'order-forms',
            'subcategory' => 'change-order-forms',
            'is_pro' => false,
            'screenshot' => IVYFORMS_TEMPLATES_IMAGES_URL . 'kitchen-upgrade-change-form.svg',
            'form_data' => [
                'name' => BackendStrings::getTemplateStrings()['kitchen_upgrade_change_form'],
                'published' => 1,
                'showTitle' => 1,
    ...
    {
        return array_merge(
            self::getNameAndContactFields(),
            self::getProjectAddressFields()
        );
    }

    /**
     * Get name and contact fields
     *
     * @return array<int, array<string, mixed>>
     */
    private static function getNameAndContactFields(): array
    {
        return [
            // Homeowner Name
            [
                ...
                'fieldIndex' => 1,
                'type' => 'name',
                'label' => BackendStrings::getTemplateStrings()['homeowner_name'],
                'parentId' => null,
                'defaultValue' => '',
                'placeholder' => '',
                'required' => true,
    ...
    /**
     * Get project address fields
     *
     * @return array<int, array<string, mixed>>
     */
    private static function getProjectAddressFields(): array
    {
        return [
            // Project Address - Parent
            [
                'id' => 0,
                'fieldIndex' => 4,
                'type' => 'address',
                'label' => BackendStrings::getTemplateStrings()['project_address'],
                'placeholder' => '',
                'required' => true,
                'parentId' => null,
                'defaultValue' => '',
    ...
    private static function getChangeRequestFields(): array
    {
        return [
            ...
            [
                ...
                'fieldIndex' => 6,
                'type' => 'select',
                'label' => BackendStrings::getTemplateStrings()['upgrade_type'],
                'placeholder' => BackendStrings::getTemplateStrings()['select_upgrade_type'],
                'required' => true,
                'parentId' => null,
                'defaultValue' => '',
                'position' => 6,
                'fieldOptions' => [
                    [
                        'id' => 0,
                        'label' => BackendStrings::getTemplateStrings()['cabinets'],
                        'value' => 'cabinets',
                        'isDefault' => false,
                        'position' => 1,
                    ],
                    [
                        'id' => 0,
                        'label' => BackendStrings::getTemplateStrings()['countertops'],
                        'value' => 'countertops',
                        'isDefault' => false,
                        'position' => 2,
                    ],
                    [
                        'id' => 0,
                        'label' => BackendStrings::getTemplateStrings()['appliances'],
                        'value' => 'appliances',
                        'isDefault' => false,
                        'position' => 3,
                    ],
                    [
                        'id' => 0,
                        'label' => BackendStrings::getTemplateStrings()['flooring'],
                        'value' => 'flooring',
                        'isDefault' => false,
                        'position' => 4,
                    ],
                    [
                        'id' => 0,
                        'label' => BackendStrings::getTemplateStrings()['lighting'],
                        'value' => 'lighting',
                        'isDefault' => false,
                        'position' => 5,
                    ],
            ...
            [
                ...
                'fieldIndex' => 8,
                'type' => 'number',
                'label' => BackendStrings::getTemplateStrings()['estimated_cost'],
                'placeholder' => BackendStrings::getTemplateStrings()['enter_estimated_cost'],
                'required' => false,
                'parentId' => null,
                'defaultValue' => '',
                'position' => 8,
    ...
    {
        return [
            // Requires Designer Approval? Radio
            [
                'id' => 0,
                'fieldIndex' => 9,
                'type' => 'radio',
                'label' => BackendStrings::getTemplateStrings()['requires_designer_approval'],
                'placeholder' => '',
                'required' => false,
                'parentId' => null,
                'defaultValue' => '',
            ...
            [
                ...
                'fieldIndex' => 10,
                'type' => 'textarea',
                'label' => BackendStrings::getTemplateStrings()['additional_notes_instructions'],
                'placeholder' => BackendStrings::getTemplateStrings()['enter_additional_notes_instructions'],
                'required' => false,
                'parentId' => null,
                'defaultValue' => '',
                'position' => 10,
