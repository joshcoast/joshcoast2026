...
namespace IvyForms\Vendor\DI\Invoker;
...
class FactoryParameterResolver implements ParameterResolver
{
    ...
    public function getParameters(
        ...
        foreach ($parameters as $index => $parameter) {
            ...
            if ($parameterClass === 'IvyForms\Vendor\Psr\Container\ContainerInterface') {
                $resolvedParameters[$index] = $this->container;
            } elseif ($parameterClass === 'IvyForms\Vendor\DI\Factory\RequestedEntry') {
