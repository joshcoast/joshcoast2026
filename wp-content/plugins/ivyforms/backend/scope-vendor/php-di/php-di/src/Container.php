...
use IvyForms\Vendor\DI\Definition\FactoryDefinition;
use IvyForms\Vendor\DI\Definition\Helper\DefinitionHelper;
use IvyForms\Vendor\DI\Definition\InstanceDefinition;
use IvyForms\Vendor\DI\Definition\ObjectDefinition;
use IvyForms\Vendor\DI\Definition\Resolver\DefinitionResolver;
use IvyForms\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use IvyForms\Vendor\DI\Definition\Source\DefinitionArray;
use IvyForms\Vendor\DI\Definition\Source\MutableDefinitionSource;
use IvyForms\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use IvyForms\Vendor\DI\Definition\Source\SourceChain;
use IvyForms\Vendor\DI\Definition\ValueDefinition;
use IvyForms\Vendor\DI\Invoker\DefinitionParameterResolver;
use IvyForms\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use IvyForms\Vendor\Invoker\Invoker;
use IvyForms\Vendor\Invoker\InvokerInterface;
use IvyForms\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use IvyForms\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use IvyForms\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use IvyForms\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
use IvyForms\Vendor\Invoker\ParameterResolver\ResolverChain;
use IvyForms\Vendor\Psr\Container\ContainerInterface;
/**
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \IvyForms\Vendor\DI\get().
     *
