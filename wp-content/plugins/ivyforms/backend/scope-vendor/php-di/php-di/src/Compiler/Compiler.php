...
namespace IvyForms\Vendor\DI\Compiler;

use function chmod;
use IvyForms\Vendor\DI\Definition\ArrayDefinition;
use IvyForms\Vendor\DI\Definition\DecoratorDefinition;
...
use IvyForms\Vendor\DI\Definition\Source\DefinitionSource;
...
use IvyForms\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \IvyForms\Vendor\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \IvyForms\Vendor\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \IvyForms\Vendor\DI\Definition\Exception\InvalidDefinition
     */
