...
1. Example for the use in the frontend
...
* Fixed frontend error which prevented the lightbox from opening.
...
* Refactored handling of SVG images.
* When WP_DEBUG is set to true, transients for image metadata will not be used.
